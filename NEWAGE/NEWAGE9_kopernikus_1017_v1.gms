...
* ------ COAL, GAS and OIL
ELEn.UP(gen,r)$(moil(gen)            and after2015(yr))  = 2.0 * ELEn.L(gen,r) + (1-thetax); // on both
ELEn.UP(gen,r)$(bGAS(gen) and eu28(r) and after2015(yr)) = 2 - ELEx.L(gen,r); // original
ELEn.UP(gen,r)$(bGAS(gen) and deu(r) and after2015(yr))  = 1.5 - ELEx.L(gen,r); // original
ELEn.UP(gen,r)$(bbc(gen)  and eun(r) and after2030(yr))  = ELEn.L(gen,r) + (1-thetax); // on both

*ELEn.UP(gen,r)$(bGAS(gen) and eu28(r) and after2015(yr)) = 4 - ELEx.L(gen,r); // used for kopernikus meeting in april
*ELEn.UP(gen,r)$(bGAS(gen) and deu(r) and after2015(yr))  = 3 - ELEx.L(gen,r); // used for kopernikus meeting in april
*ELEn.UP(gen,r)$(mgas(gen) and deu(r) and after2025(yr))  = 2 * ELEn.L(gen,r) ; // used for kopernikus meeting in april
...
ELEn.UP(gen,r)$(mwind(gen)  and deu(r) and after2015(yr))= 1.5 * ELEn.L(gen,r) ; // original
ELEn.UP(gen,r)$(msolar(gen) and deu(r) and after2015(yr))= 1.5 * ELEn.L(gen,r) ; // changed here
*ELEn.UP(gen,r)$(msolar(gen) and deu(r) and after2015(yr))= 1.35 * ELEn.L(gen,r) ; // used for kopernikus meeting in april
*ELEn.UP(gen,r)$(mwind(gen)  and deu(r) and after2015(yr))= 1.3 * ELEn.L(gen,r) ; // used for kopernikus meeting in april
*ELEn.UP(gen,r)$(mwind(gen)  and deu(r) and after2015(yr) and before2035(yr))= 1.5 * ELEn.L(gen,r) ; // tested for kopernikus meeting in april
*ELEn.UP(gen,r)$(mwind(gen)  and deu(r) and after2030(yr))= 1.2 * ELEn.L(gen,r) ; // tested for kopernikus meeting in april
