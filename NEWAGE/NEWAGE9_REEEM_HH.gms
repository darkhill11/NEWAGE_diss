...
* ------ Quotas/Flags/Shares in electricty generation and ETS allowances
         ...
         etstrade        Defines carbon regime as EU-28 ETS      permit price PCO2_ETS                   / 1 /   // ETStrade --> Schalter for basis scenario /article
...
*         aeei_variante   Schalter f�r Einstaz der McKinsey AEEI sektoral u. zeitlich spezifiziert        / 0 /
         ...
         REEEM_regpush    switch to turn on the regional push scenario for REEEM                            / 1 / // article
         ...
         REEEM_LS                                                                                           / 0 /
         REEEM_all_tiCap_95     switch to turn on tighter cap (95% red) for ALL Sectors                     / 1 / // article
...
* ------ 01.04.2020
         BTA_coa(r)     coalition BCA experiment  / DEU, FRA, ITA, POL, UKI, ESP, BNL, EUN, EUS, USA, OEC/
;
...
* ------ parameters specifc for hh disaggregation
         ...
         c_hh0(i,r)     final demand by commodity for households
         c_gov0(i,r)    final demand by commodity for government
...
* ----- 11.09.17 sector-specific emissions
    carblim_sec(sec,r)  sector-specific carbon emission limits for Germany
    carblim_sec0(sec,r) sector-specific carbon emission limits for Germany (benchmark)
...
* ------ LOAD
$LOAD    ressize
$LOAD    co2pfad_ets  co2pfad co2pfad_ets_eu co2pfad_ets_row co2pfad_ets_row_2dc co2pfad_nonets co2pfad_nonets_2dc co2pfad_DEU co2pfad_E3_eu co2pfad_cluni_nonets co2pfad_cluni_ets co2pfad_E4_eu co2pfad_regpush co2pfad_REEEM_ets90 co2pfad_REEEM_ets95 co2pfad_REEEM_all90 co2pfad_REEEM_all95
$LOAD    URUN0  URSK0
...
pricetarget("cru",r)             = 1 ;	// exogenous price path for crude oil
pricetarget("col",r)             = 1 ;	// exogenous price path for coal
pricetarget("gas",r)             = 1 ;	// exogenous price path for gas
...
$LOAD hh_consumption, total_cons
$GDXIN
...
share_oil_heat("hh1","DEU")=0.302242052658592;
share_oil_heat("hh1","FRA")=0.141561120629091;
share_oil_heat("hh1","ITA")=0.0289444688227374;
share_oil_heat("hh1","POL")=0.00536554399181265;
share_oil_heat("hh1","UKI")=0.0842704802868978;
share_oil_heat("hh1","BNL")=0.439948682430815;
share_oil_heat("hh1","ESP")=0.058388613441467;
share_oil_heat("hh1","EUN")=0.0184354211038372;
share_oil_heat("hh1","EUS")=0.0396918116143359;
share_oil_heat("hh2","DEU")=0.246085779226251;
share_oil_heat("hh2","FRA")=0.141699283916837;
share_oil_heat("hh2","ITA")=0.0311500391764387;
share_oil_heat("hh2","POL")=0.00381107022652629;
share_oil_heat("hh2","UKI")=0.0662066160334716;
share_oil_heat("hh2","BNL")=0.39708211770727;
share_oil_heat("hh2","ESP")=0.0783055580155617;
share_oil_heat("hh2","EUN")=0.109364584727474;
share_oil_heat("hh2","EUS")=0.0285297170336967;
share_oil_heat("hh3","DEU")=0.226925318015655;
share_oil_heat("hh3","FRA")=0.120412835878755;
share_oil_heat("hh3","ITA")=0.0365614130370613;
share_oil_heat("hh3","POL")=0.00300026628296295;
share_oil_heat("hh3","UKI")=0.0662441603705449;
share_oil_heat("hh3","BNL")=0.35138398555641;
share_oil_heat("hh3","ESP")=0.0699544591603565;
share_oil_heat("hh3","EUN")=0.0851094655273188;
share_oil_heat("hh3","EUS")=0.0614248812798266;
share_oil_heat("hh4","DEU")=0.219674873668163;
share_oil_heat("hh4","FRA")=0.0899373688865063;
share_oil_heat("hh4","ITA")=0.0404777369600626;
share_oil_heat("hh4","POL")=0.0100252255323349;
share_oil_heat("hh4","UKI")=0.0574838560513717;
share_oil_heat("hh4","BNL")=0.347655649936276;
share_oil_heat("hh4","ESP")=0.0607285105968149;
share_oil_heat("hh4","EUN")=0.0697927416882297;
share_oil_heat("hh4","EUS")=0.163867557164398;
share_oil_heat("hh5","DEU")=0.224328316102801;
share_oil_heat("hh5","FRA")=0.126395503921772;
share_oil_heat("hh5","ITA")=0.0370197455027676;
share_oil_heat("hh5","POL")=0.0154689862519787;
share_oil_heat("hh5","UKI")=0.0626119589013879;
share_oil_heat("hh5","BNL")=0.342438817999883;
share_oil_heat("hh5","ESP")=0.0708904384001453;
share_oil_heat("hh5","EUN")=0.09151510072076;
share_oil_heat("hh5","EUS")=0.252430790774133;

share_oil_heat("regional",r)$HH_DISAG(r) = sum(hh,c_hh0("oil",r) * hh_sector_share(r,"oil",hh) * share_oil_heat(hh,r))/c_hh0("oil",r);
...
cc(i,s,r)$vom(i,s) = sum(fe, co2em(fe,i,s))/vom(i,s);

display "Direct Carbon Content:", cc;

cc(i,s,r)$vom(i,s) = sum(fe, co2em(fe,i,s))/vom(i,s) +
                    sum(fe, co2em(fe,"ele",s)) / vom("ele",s) * vafm("ele",i,r) /vom(i,s);

display "Indirect Carbon Content:", cc;

bta_sec_reg(i,s,r) = 0;
bta_sec_reg(i,s,r)$(NOT BTA_coa(s) and BTA_coa(r) and BTA_sec(i) and bta) = 1;
...
* the # represents multiple inputs for PCO2, one for each element of set fe
         ...
         i:PCO2W#(fe)$eu28(r)$eutrade             q:(co2em(fe,"g",r) * aeei(fe,"c",r))        p:1e-6  fe.tl:          a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r)
*         i:PCO2W#(fe)$deu(r)$detrade              q:(co2em(fe,"final",r) * aeei(fe,"c",r))        p:1e-6  fe.tl:          a:RA(r)
...
* ------ All consumption goods (DEU: except transport, energy, cars and buildings)
* .tl alerts MPSGE that a set of nests are being declared
         i:PA(i,r)$(not e(i))                    q:(c_hh0(i,r) * hh_sector_share(r,i,hh))                       p:pc_hh0(i,r) i.tl:$fe(i) c:$(not e(i)) e:$ele(i)  a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(i,r)
* ------ Residential crude oil is NOT used for combustion --> no CO2-emissions --> no climate policy relevance
...
* the # represents multiple inputs for PCO2, one for each element of set fe
         ...
         i:PCO2W#(fe)$eu28(r)$eutrade             q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh))        p:1e-6  fe.tl:          a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r)
*         i:PCO2W#(fe)$deu(r)$detrade              q:(co2em(fe,"final",r) * aeei(fe,"c",r))        p:1e-6  fe.tl:          a:RA(r)
         ...
         i:PCO2_NETSr(r)#(fe)$eu28(r)$netstrade_r q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh))        p:1e-6  fe.tl:          a:ra(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r)    t:(carbon_tax(r)/co2coefc_hh(fe,r))
...
$prod:C_hh(hh,r)$(HH_DISAG(r) and h_t_cons_reg(r))       s:0.5   c:1    h:0.6   tr:1    ct(tr):1     e(h):1     oil(e):0   col(e):0   gas(e):0
...
* .tl alerts MPSGE that a set of nests are being declared
         ...
         i:p_oil_trans(r)                            q:((c_hh0("oil",r) * pc_hh0("oil",r) * (1 - share_oil_heat("regional",r)) * hh_sector_share(r,"oil",hh)) + (c_hh0("mvh",r) * pc_hh0("mvh",r) * hh_sector_share(r,"mvh",hh)))     ct:
         i:p_ele_trans(r)                            q:(bmk_ele_trans * (((10 * pc_hh0("mvh",r) * hh_sector_share(r,"mvh",hh))) + (1 * pc_hh0("ele",r) * hh_sector_share(r,"ele",hh))))                    ct:
* ------ Residential crude oil is NOT used for combustion --> no CO2-emissions --> no climate policy relevance
         i:PA(i,r)$cru(i)                        q:(c_hh0(i,r) * hh_sector_share(r,i,hh))                       p:pc_hh0(i,r) i.tl:$fe(i)               e:$ele(i)  a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(i,r)

* ------ Non-DEU: energy
         i:PA(e,r)$oil(e)                       q:((c_hh0(e,r)*aeei(e,"c",r)) * hh_sector_share(r,e,hh) * share_oil_heat(hh,r))      p:pc_hh0(e,r) e.tl:$fe(e)  e:$ele(e)  a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(e,r)
         i:PA(e,r)$ele(e)                       q:((c_hh0(e,r)*aeei(e,"c",r)) * hh_sector_share(r,e,hh))         p:pc_hh0(e,r) e.tl:$fe(e)  e:$ele(e)  a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(e,r)
         i:PA(e,r)$gas(e)                       q:((c_hh0(e,r)*aeei(e,"c",r)) * hh_sector_share(r,e,hh))         p:pc_hh0(e,r) e.tl:$fe(e)  e:$ele(e)  a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(e,r)
         i:PA(e,r)$col(e)                       q:((c_hh0(e,r)*aeei(e,"c",r)) * hh_sector_share(r,e,hh))         p:pc_hh0(e,r) e.tl:$fe(e)  e:$ele(e)  a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(e,r)
...
* ------ Carbon regimes:
* the # represents multiple inputs for PCO2, one for each element of set fe
         i:PCO2(r)#(fe)$notrad(r)                 q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))      p:1e-6  fe.tl:      a:GOV(r)
         i:PCO2W#(fe)$pco2w_r(r)$worldtrade       q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))      p:1e-6  fe.tl:      a:GOV(r)
         i:PCO2W#(fe)$eu28(r)$eutrade             q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))      p:1e-6  fe.tl:      a:GOV(r)
*         i:PCO2W#(fe)$deu(r)$detrade              q:(co2em(fe,"final",r) * aeei(fe,"c",r))        p:1e-6  fe.tl:          a:RA(r)
         i:PCO2W#(fe)$noneu28(r)$worldtrade2      q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))      p:1e-6  fe.tl:      a:GOV(r)
         i:PCO2_NETS#(fe)$eu28(r)$netstrade       q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))      p:1e-6  fe.tl:
         i:PCO2_NETSr(r)#(fe)$eu28(r)$netstrade_r q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))      p:1e-6  fe.tl:      a:GOV(r)    t:(carbon_tax(r)/co2coefc_hh(fe,r))
...
* ----- 26.01.2018
         i:PCO2(r)#(fe)$(deu(r) and detrade)                 q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))        p:1e-6  fe.tl:      a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r)
* --------------------------------------------------------------------------------

$prod:FF_trans(r)$(HH_DISAG(r) and h_t_cons_reg(r))   s:0     oil(s):0
    
         o:p_oil_trans(r)                    q:((c_hh0("oil",r) * pc_hh0("oil",r) * (1 - share_oil_heat("regional",r))) + (c_hh0("mvh",r) * pc_hh0("mvh",r)))

         i:PA(i,r)$mvh(i)                q:c_hh0(i,r)                                             p:pc_hh0(i,r)               a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(i,r) 

         i:PA(e,r)$oil(e)                q:(c_hh0(e,r) * (1 - share_oil_heat("regional",r)))      p:pc_hh0(e,r)     oil:   a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(e,r)            

         i:PCO2(r)$notrad(r)                 q:(co2em("oil","c",r) * aeei("oil","c",r) * (1- share_oil_heat("regional",r)))        p:1e-6  oil:           a:GOV(r)
         i:PCO2W$pco2w_r(r)$worldtrade       q:(co2em("oil","c",r) * aeei("oil","c",r) * (1- share_oil_heat("regional",r)))        p:1e-6  oil:           a:GOV(r)
         i:PCO2W$eu28(r)$eutrade             q:(co2em("oil","c",r) * aeei("oil","c",r) * (1- share_oil_heat("regional",r)))        p:1e-6  oil:           a:GOV(r)
*         i:PCO2W#(fe)$deu(r)$detrade              q:(co2em(fe,"final",r) * aeei(fe,"c",r))        p:1e-6  fe.tl:          a:RA(r)
         i:PCO2W$noneu28(r)$worldtrade2      q:(co2em("oil","c",r) * aeei("oil","c",r) * (1- share_oil_heat("regional",r)))        p:1e-6  oil:           a:GOV(r)
         i:PCO2_NETS$eu28(r)$netstrade       q:(co2em("oil","c",r) * aeei("oil","c",r) * (1- share_oil_heat("regional",r)))        p:1e-6  oil:
         i:PCO2_NETSr(r)$eu28(r)$netstrade_r q:(co2em("oil","c",r) * aeei("oil","c",r) * (1- share_oil_heat("regional",r)))        p:1e-6  oil:           a:GOV(r)    t:(carbon_tax(r)/co2coefc_hh("oil",r))
...
* ----- 26.01.2018
         i:PCO2(r)#(fe)$(deu(r) and detrade)                 q:(co2em("oil","c",r) * aeei("oil","c",r) * (1- share_oil_heat("regional",r)))        p:1e-6  oil:          a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r)

$prod:ELE_trans(r)$(HH_DISAG(r) and h_t_cons_reg(r))   s:0
    
         o:p_ele_trans(r)              q:(((10 * pc_hh0("mvh",r))) + (1 * pc_hh0("ele",r)))

         i:PA(i,r)$mvh(i)              q:10           p:pc_hh0(i,r)        a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(i,r)

         i:PA(e,r)$ele(e)              q:1            p:pc_hh0(e,r)        a:RA(r)$(not HH_DISAG(r)) a:GOV(r)$HH_DISAG(r) t:tp(e,r)
...
*ELEx.fx(gen,r)$(bbc(gen)  and eus(r) and yr2030(yr))  = elen.l(gen,r);
...
*ELEn.up(gen,r)$(mwind(gen)  and eu28(r) and yr2020(yr) and REEEM_calib)= 1.15 * elen.l(gen,r); //
*ELEn.up(gen,r)$(msolar(gen)  and eu28(r) and yr2020(yr) and REEEM_calib)= 1.1 * elen.l(gen,r);

*ELEn.up(gen,r)$(mwind(gen)  and eu28(r) and yr2030(yr) and REEEM_calib)= 1.15 * elen.l(gen,r); //
*ELEn.up(gen,r)$(msolar(gen)  and eu28(r) and yr2030(yr) and REEEM_calib)= 1.1 * elen.l(gen,r);
...
*ELEn.up(gen,r)$( mwind(gen)  and deu(r) and yr2020(yr))= 1.2 ;
...
*ELEn.UP(gen,r)$(NOT ele_dev_switch_actual(gen,r) AND mwind(gen)  and deu(r) and after2020(yr))= 1.2 * ELEn.L(gen,r) ; // BASELINE
...
*ELEn.up(gen,r)$( msolar(gen)  and deu(r) and yr2020(yr))= 1.4 ;
...
* ------ 9.02.2016 CO2-Pfad f?r ETStrade [Quelle: CO2-Pfad EU-ETS.xlsx in D:\GAMS\GTAP8inGAMS\Rutherford - EnHH - 11\xcel_data]
* ------ 13.04.2016
...
* ---- GDP Composites
    ...
    gdpreal_disag_yr("total_no_cons_tax",r,yr)      = gdpreal_yr(r,yr) - sum(hh, cons_hh_accounts(r,hh,"tax_inputs",yr));
