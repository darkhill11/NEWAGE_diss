...
*         PCO2W$eutrade                         ! International Permit Price
         PCO2Wr(r)$(eu28(r) AND eutrade)        ! International Permit Price. This price is used in combination with PCO2W to decribe how many carbon certificates each region within PCO2W uses
         PCO2W$eutrade                          ! International Permit Price
...
$prod:CEMIT(r)$(EU28(r) and eutrade)
         o:PCO2Wr(r)        q:1
         i:PCO2W            q:1
         i:PUSK(r)          q:2e-6
...
* the # represents multiple inputs for PCO2, one for each element of set fe
         ...
         i:PCO2Wr(r)#(fe)$eu28(r)$eutrade             q:(co2em(fe,"c",r) * aeei(fe,"c",r) * hh_sector_share(r,fe,hh) * ( share_oil_heat(hh,r)$(oil(fe)) + 1$(NOT oil(fe))))      p:1e-6  fe.tl:      a:GOV(r)
*         i:PCO2W#(fe)$deu(r)$detrade              q:(co2em(fe,"final",r) * aeei(fe,"c",r))        p:1e-6  fe.tl:          a:RA(r)
