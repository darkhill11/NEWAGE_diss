...
* ------ 10.04.2014 SOURCE
* ------ 18.10.2016 v2 and upper already with mapping 18x18x4 for REEM project
...
*------- 24.10.2016 some lines were deleted due to new mapping
* ------ COAL, GAS and OIL
...
*$ontext
co2pfad_ets(r,yr)$(eu28(r) and (eutrade or notrade) and yr2011(yr)) = 1.000  ;       // mit Diss
co2pfad_ets(r,yr)$(eu28(r) and (eutrade or notrade) and yr2015(yr)) = 0.909218 ;     // mit Diss
co2pfad_ets(r,yr)$(eu28(r) and (eutrade or notrade) and yr2020(yr)) = 0.878756 ;     // mit Diss
co2pfad_ets(r,yr)$(eu28(r) and (eutrade or notrade) and yr2025(yr)) = 0.837546 ;     // mit Diss
co2pfad_ets(r,yr)$(eu28(r) and (eutrade or notrade) and yr2030(yr)) = 0.737879 ;     // mit Diss
*$offtext
...
effh_target(r)$(deu(r) and yr2011(yr))   = effh_avg(r) ;
...
* ------ 23.01.2016
$ontext
*ssd(r,ct,cf)$yr2011(yr) = ssd(r,ct,cf) * (1-0.20)**3 + VNC_NEWCAR.L(r,ct,cf) * PNEWCAR.L(r,ct,cf) * 1.5;
*ssd(r,ct,cf)$after(yr)  = ssd(r,ct,cf) * (1-0.20)**5 + VNC_NEWCAR.L(r,ct,cf) * PNEWCAR.L(r,ct,cf) * 3;
...
***ssd(r,ct,cf)$after2015(yr)= ssd(r,ct,cf) * (1-0.05)**5 + anz_car(r,ct,cf,"new",yr) * ssd0price(r,ct,cf) * 5; display ssd;
...
* ------ 7.02.2016 auskommentiert (unten)
$ontext
bsdyr(r,bt,bf,"2011")$yr2007(yr) = anz_qm(r,bt,bf,yr)$new(bt) * qmcostc_disc(r,bt,bf) ;
...
bsdyr(r,bt,bf,"2011")$after(yr)     = bsdyr(r,bt,bf,"2010") * (1 - 0.1)**3 ;
...
* ------ 23.01.2016
*bsdyr(r,bt,bf,"2011")$yr2007(yr) = bsd0(r,bt,bf) * NEWHOUSE.L(r,bt,bf) * 3 ;
