...
$if not set resultsdir   $set resultsdir "..\results\diss\201201\"
...
* ------ Create merged.gdx
Execute 'gdxmerge %resultsdir%diss_ref.gdx %resultsdir%diss_BAU.gdx %resultsdir%diss_CAP.gdx %resultsdir%diss_VAT.gdx %resultsdir%diss_LAB.gdx output=%resultsdir%merged.gdx';
