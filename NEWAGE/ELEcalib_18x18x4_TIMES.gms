...
* ------ 3.02.2016 BAW entfernen
$libinclude xlimport     ele_prod_costs  %xcel_datadir%ele_prod_costs_TIMES.xlsx     ele_prod_costs!A2:S20         // 18x18x4 for REEEM
...
Execute_Unload '%datadir%%output%_ELE_TIMES', vafm_input, cap_input, skl_input, usk_input, vafm_ele, costshr_calib, ele_prod, ele_prod_costs, costshr, cost_gen_gtap, cost_gen_shr,VOA, cost_gen, ele_dev_switch;
