$TITLE  NEWAGE 17x18x4 -- GTAP9 -- Calibration of Electricity Generation
...
$libinclude xlimport     ele_prod        %xcel_datadir%ele_prod.xlsx           ele_prod!A2:R20                  // 17x18x4 ohne BAW
...
* ------ 3.02.2016 BAW entfernen
$libinclude xlimport     ele_prod_costs  %xcel_datadir%ele_prod_costs.xlsx     ele_prod_costs!A2:R20         // 17x18x4 ohne BAW
...
* ------ 3.02.2016 BAW entfernen
$libinclude xlimport     costshr         %xcel_datadir%costshr.xlsx            costshr!A3:V309                // 17x18x4 ohne BAW
...
Execute_Unload '%datadir%%output%_ELE', vafm_input, cap_input, skl_input, usk_input, vafm_ele, costshr_calib, ele_prod, ele_prod_costs ;
