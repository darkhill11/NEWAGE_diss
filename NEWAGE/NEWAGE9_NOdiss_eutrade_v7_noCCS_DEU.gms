...
scalar
        noCOAL_DEU  switch for coal decomissioning in germany till 2030 /1/; // if (1) = coal decomissioning till 2030; else = NO coal decomissioning till 2030   
...
ELEn.UP(gen,r)$(bGAS(gen) and eu28(r) and after2015(yr)) = 2 - ELEx.L(gen,r);
ELEn.UP(gen,r)$(bGAS(gen) and deu(r) and after2015(yr))  = 1.5 - ELEx.L(gen,r);
...
* ------ mWIND and mSOLAR
ELEn.UP(gen,r)$(mwind(gen)  and deu(r) and after2015(yr))= 1.5 * ELEn.L(gen,r) ;
