...
$libinclude      xlimport        abschreibung            %xcel_datadir%abschreibung.xlsx       abschreibung!A3:K309
$libinclude      xlimport        abschreibung_bmk        %xcel_datadir%abschreibung.xlsx       abschreibung_bmk!A3:K309

* ###### abschreibung_z ########################################################
* ------ include abschreibung for decommissioning curves for others
$libinclude      xlimport        abschreibung_z          %xcel_datadir%abschreibung.xlsx       abschreibung_z!A3:K201
$libinclude      xlimport        abschreibung_bmk_z      %xcel_datadir%abschreibung.xlsx       abschreibung_bmk_z!A206:K404
...
$libinclude      xlimport        co2pfad_ets             %xcel_datadir%150730_co2pfad_BMWi.xlsx         DEHst_1vs4!B72:k78       # DEHst Szenario 1 - Status Quo (aktualisiert) [REF]
...
* ------ 1.04.2016
$libinclude      xlimport        co2pfad_ets_eu          %xcel_datadir%160330_co2pfad.xlsx               EU-Pfad!B69:k70           # EU-Emissionsreduktionspfad gemäß historisch verfügbarer Zertifikate bis 2013 (http://www.eea.europa.eu/data-and-maps/data/data-viewers/emissions-trading-viewer) und der Emissionsreduktionsziele -21% in 2020 und -43% in 2030
...
* ------ 3.02.2016 BAW entfernen
$libinclude      xlimport        co2pfad                 %xcel_datadir%150730_co2pfad_BMWi.xlsx         co2pfad_nonets!B22:K39   # bleibt vorerst gleich [ORIGINAL]
...
* ------ 3.02.2016 BAW entfernen
$libinclude      xlimport        ressize         %xcel_datadir%ressize.xlsx      ressize!B73:L141
display  ressize ;
...
$libinclude      xlimport        lfhc_usk        %xcel_datadir%size_18x18x4.xlsx  size_17x18x4!G20:P37
$libinclude      xlimport        lfhc_skl        %xcel_datadir%size_18x18x4.xlsx  size_17x18x4!G2:P19
...
$libinclude      xlimport        tfp     %xcel_datadir%ep+tfp.xlsx       tfp_newage!A32:R41

* ------ 16.07.2014 ORIGINAL
*$libinclude      xlimport         ep     %xcel_datadir%ep+tfp.xlsx        ep_newage!A30:R40
* ------ 16.07.2014 Halber Zuwachs
$libinclude      xlimport         ep     %xcel_datadir%ep+tfp.xlsx        ep_newage!A91:R100
