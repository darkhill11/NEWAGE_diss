...
parameters
        ...
        vdep_(rr)       Value of capital depreciation,
        vkb_(rr)        Value of capital stock,
        save_(rr)       Savings;
...
put_utility 'title' /"Aggregating vdep.";
$batinclude aggr vdep r vdep_
put_utility 'title' /"Aggregating vkb.";
$batinclude aggr vkb r vkb_
put_utility 'title' /"Aggregating save.";
$batinclude aggr save r save_
...
execute_unload '%datadir%%output%.gdx',
        ...
        vdep_=vdep, vkb_=vkb, save_=save;
